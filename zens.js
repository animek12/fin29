...
const nyoutube = ('®  Fin-Md')  //ubah di config biar ngk emror
...
module.exports = zens = async (zens, m, chatUpdate, store) => {
    try {
		...
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":'®Zenss', "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': '®Fin-Md', 'jpegThumbnail': thumb}}}
